...
class DBTest(unittest.TestCase):
    ...
    def test_order(self):
        """Test, that matches are sorted by prio, descending mathc length, subprio, name"""
        data =[
            [
                # name     type        file    extra       location        prio subprio
        ...
        assert [r[0] for r in m] == ["order_0", "order_3", "order_2", "order_0", "order_1", "order_4_"], [r[0] for r in m]
